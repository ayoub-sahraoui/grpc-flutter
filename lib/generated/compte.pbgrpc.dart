...
class CompteServiceClient extends $grpc.Client {
  ...
  static final _$findComptesByType = $grpc.ClientMethod<$0.FindComptesByTypeRequest, $0.FindComptesByTypeResponse>(
      '/CompteService/FindComptesByType',
      ($0.FindComptesByTypeRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.FindComptesByTypeResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.FindComptesByTypeResponse> findComptesByType($0.FindComptesByTypeRequest request, {$grpc.CallOptions? options}) {
...
abstract class CompteServiceBase extends $grpc.Service {
  ...
  CompteServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.FindComptesByTypeRequest, $0.FindComptesByTypeResponse>(
        'FindComptesByType',
        findComptesByType_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.FindComptesByTypeRequest.fromBuffer(value),
        ($0.FindComptesByTypeResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.FindComptesByTypeResponse> findComptesByType_Pre($grpc.ServiceCall call, $async.Future<$0.FindComptesByTypeRequest> request) async {
  ...
  $async.Future<$0.FindComptesByTypeResponse> findComptesByType($grpc.ServiceCall call, $0.FindComptesByTypeRequest request);
}

...
class FindComptesByTypeRequest extends $pb.GeneratedMessage {
  factory FindComptesByTypeRequest({
    TypeCompte? type,
  }) {
    final $result = create();
    if (type != null) {
  ...
  FindComptesByTypeRequest._() : super();
  factory FindComptesByTypeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FindComptesByTypeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindComptesByTypeRequest', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FindComptesByTypeRequest clone() => FindComptesByTypeRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FindComptesByTypeRequest copyWith(void Function(FindComptesByTypeRequest) updates) => super.copyWith((message) => updates(message as FindComptesByTypeRequest)) as FindComptesByTypeRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FindComptesByTypeRequest create() => FindComptesByTypeRequest._();
  FindComptesByTypeRequest createEmptyInstance() => create();
  static $pb.PbList<FindComptesByTypeRequest> createRepeated() => $pb.PbList<FindComptesByTypeRequest>();
  @$core.pragma('dart2js:noInline')
  static FindComptesByTypeRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FindComptesByTypeRequest>(create);
  static FindComptesByTypeRequest? _defaultInstance;
...
class FindComptesByTypeResponse extends $pb.GeneratedMessage {
  factory FindComptesByTypeResponse({
    $core.Iterable<Compte>? comptes,
  }) {
    final $result = create();
    if (comptes != null) {
  ...
  FindComptesByTypeResponse._() : super();
  factory FindComptesByTypeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FindComptesByTypeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindComptesByTypeResponse', createEmptyInstance: create)
    ..pc<Compte>(1, _omitFieldNames ? '' : 'comptes', $pb.PbFieldType.PM, subBuilder: Compte.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FindComptesByTypeResponse clone() => FindComptesByTypeResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FindComptesByTypeResponse copyWith(void Function(FindComptesByTypeResponse) updates) => super.copyWith((message) => updates(message as FindComptesByTypeResponse)) as FindComptesByTypeResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FindComptesByTypeResponse create() => FindComptesByTypeResponse._();
  FindComptesByTypeResponse createEmptyInstance() => create();
  static $pb.PbList<FindComptesByTypeResponse> createRepeated() => $pb.PbList<FindComptesByTypeResponse>();
  @$core.pragma('dart2js:noInline')
  static FindComptesByTypeResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FindComptesByTypeResponse>(create);
  static FindComptesByTypeResponse? _defaultInstance;

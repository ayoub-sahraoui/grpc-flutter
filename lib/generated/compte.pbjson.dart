...
@$core.Deprecated('Use findComptesByTypeRequestDescriptor instead')
const FindComptesByTypeRequest$json = {
  '1': 'FindComptesByTypeRequest',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.TypeCompte', '10': 'type'},
  ],
};

/// Descriptor for `FindComptesByTypeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List findComptesByTypeRequestDescriptor = $convert.base64Decode(
    'ChhGaW5kQ29tcHRlc0J5VHlwZVJlcXVlc3QSHwoEdHlwZRgBIAEoDjILLlR5cGVDb21wdGVSBH'
    'R5cGU=');

@$core.Deprecated('Use findComptesByTypeResponseDescriptor instead')
const FindComptesByTypeResponse$json = {
  '1': 'FindComptesByTypeResponse',
  '2': [
    {'1': 'comptes', '3': 1, '4': 3, '5': 11, '6': '.Compte', '10': 'comptes'},
  ],
};

/// Descriptor for `FindComptesByTypeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List findComptesByTypeResponseDescriptor = $convert.base64Decode(
    'ChlGaW5kQ29tcHRlc0J5VHlwZVJlc3BvbnNlEiEKB2NvbXB0ZXMYASADKAsyBy5Db21wdGVSB2'
    'NvbXB0ZXM=');
